...
const LoginView = ({ onLogin, onSwitchToSignUp, formData, handleChange }) => (
  <div className="glass-card p-5 mx-auto fade-up" style={{ maxWidth: "500px", width: "100%" }}>
    ...
    <form onSubmit={(e) => { e.preventDefault(); onLogin(); }}>
      <GlassInput id="workEmail" label="Email Address" value={formData.workEmail} onChange={handleChange} type="email" placeholder="arshad@example.com" />
      ...
      <button type="submit" className="btn w-100 py-3 mt-4 fw-bold text-uppercase"
